        ...
        <div className={styles.left}>
          <Card className={`${styles.card_css}  `} style={{ width: "25rem" }}>
            <Card.Body>
              ...
              <button  className={`${styles.button_css} px-4 me-3 `}>Flat/Apartment</button>
              <button className={`${styles.button_css} px-4 me-3 `}>Villa</button>
              <button  className={`${styles.button_css} px-4 me-3 `}>PLot</button>
