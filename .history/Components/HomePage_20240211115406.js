        ...
        <div className={styles.left}>
          <Card className={`${styles.card_css}  `} style={{ width: "25rem" }}>
            <Card.Body>
              ...
              <button  className={`${styles.button_css} px-4 me-3 `}>Sell</button>
              <button className={`${styles.button_css} px-4 me-3 `}>Rent</button>
              <p className="fw-bold mt-2">Property Type</p>
              <button  className={`${styles.button_css} px-4 me-3 `}>Residential</button>
              <button className={`${styles.button_css} px-4 me-3 `}>Commercial</button>
              <button  className={`${styles.button_css} px-2 me-2 mt-2 `}>Flat/Apartment</button>
              <button className={`${styles.button_css} px-2 me-2 mt-2`}>Villa</button>
              <button  className={`${styles.button_css} px-2 me-2 mt-2 `}>PLot</button>
              <button className={`${styles.button_css} px-2 me-2 mt-2 `}>Independent HOuse</button>
              <button  className={`${styles.button_css} px-2 me-2 mt-2 `}>Builder Floor</button>
              <p className="fw-bold mt-2">Add Your Contact Detail</p>
              <button  className={`${styles.button_css} px-4 me-3 `}>Phone Number</button>
